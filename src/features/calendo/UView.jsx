...
const UView = ({ store, operation }) => {
  ...
  return (
    <>
      <LoadingScreen isLoading={isLoading} setIsLoading={setIsLoading} store={store} logoUrl="/U/U-LOGO.png" />
      <StyledMain isUView>
        ...
        <ContentWrapper>
          ...
          <SectionWrapper>
            <FormSection operation={operation} />
          </SectionWrapper>
          <Footer />
        </ContentWrapper>
      </StyledMain>
